namespace hypothekenrechner_programm
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("");
            Console.WriteLine("Bitte geben sie in dem ganzen Programm nur Zahlen ein, da sonst Fehleingaben enstehen. Bitte verwenden sie auch keine Sonderzeichen, wie % etc. ausser sie werden darum gebeten.");
                ...
                try
                {
                    ...
                    while (y == true)
                    {
                        ...
                        else if (menuPunkt == "2")
                        {
                            ...
                            Console.WriteLine("_____________________________________________________________________________________________________________________");
                            Console.WriteLine("geben sie die Laufzeit ein,also wie viele Jahre sie in der Wohnung wohnen wollen: ");
                            ...
                            Console.WriteLine("Die Kosten für einen Kauf eines Hauses beträgt: " + Jahreszinsbelastung * laufzeit);

                            gesamtMiete = Mietbetrag * laufzeitwohnung * 12;
                            gesamtHaus = Jahreszinsbelastung * laufzeit;
                            ...
                            else if (gesamtMiete < gesamtHaus)
                            {
                                Console.WriteLine("");
